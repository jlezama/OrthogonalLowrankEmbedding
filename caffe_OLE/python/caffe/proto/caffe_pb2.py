...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='largemargin_inner_product_param', full_name='caffe.LayerParameter.largemargin_inner_product_param', index=59,
